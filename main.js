/**
 * Yoopedia - Main Application Logic (Reverted to Stable Version)
 * Features: Auth State, Search, Popups, Featured Articles, Suggestions
 */
...
// ============================================
// 🔐 AUTH STATE (Original - No Image Manipulation)
// ============================================
...
// ============================================
// ⭐ LOAD FEATURED ARTICLES (Simple & Reliable)
// ============================================
async function loadFeaturedArticles() {
  ...
  try {
    ...
    snapshot.forEach(docSnap => {
      ...
      box.addEventListener("click", () => { window.location.href = `../article/article.html?id=${docSnap.id}`; });
